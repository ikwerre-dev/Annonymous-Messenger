			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-23 usernameparent" onsubmit="return none" data-validate = "Username is reauired">
						<span class="label-input100">Add Your username</span>
					...
					<div class="wrap-input100 validate-input passcodeparent " data-validate="Passcode is required">
						<span class="label-input100">4 Digit Code</span>
						<input class="input100 " style="letter-spacing: 3rem;" type="number" maxlength="4" minlength="4" id="passcode" name="pass" placeholder="****">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<button id="registerbtn" class="login100-form-btn">
								Register
							</button>
						</div>
					</div>
